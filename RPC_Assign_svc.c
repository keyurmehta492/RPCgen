...
rpc_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case mergeSort:
		_xdr_argument = (xdrproc_t) xdr_sortArray;
		_xdr_result = (xdrproc_t) xdr_sortArray;
	...
	case encryptEcho:
		...
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (char *(*)(char *, struct svc_req *)) encryptecho_1_svc;
		break;
	...
	case addComplx:
		_xdr_argument = (xdrproc_t) xdr_complxNo;
		_xdr_result = (xdrproc_t) xdr_complxNo;
		local = (char *(*)(char *, struct svc_req *)) addcomplx_1_svc;
		break;
